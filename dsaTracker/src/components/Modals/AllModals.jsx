...
function AllModals({ theme, problemsState, formDataState, modalControls, editState }) {
  return (
    <>
      <AddProbModal theme={theme} problemsState={problemsState} formDataState={formDataState} modalControls={modalControls} />

      <RandomProbModal theme={theme} problemsState={problemsState} modalControls={modalControls} />
